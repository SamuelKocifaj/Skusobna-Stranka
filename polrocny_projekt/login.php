...
<form id="Login"class="input-group" method ="post">
    ...
    <input type="text"  name="login_heslo" class="input-field"placeholder="Enter Password " required>
...
<form id="Register"class="input-group" method ="post">
    ...
    <input type="text" name="heslo" class="input-field" placeholder="Enter Password"  required>

    <input type="checkbox"class="check-box"><span>Suhlasim ze som pozitivne naladeny</span>
...
if($_POST){
    if (isset($_POST['register_button'])) {
        ...
        if(strlen($heslo) <6){
            ...
            $sqli = "INSERT INTO usertable (user_username, user_email, user_password) VALUES ('$meno', '$email', '$heslo')";
            $conn ->query($sqli);
